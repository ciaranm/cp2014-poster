...
\settitle{
    \begin{tikzpicture}
        \node (T) [inner sep=0pt] {\begin{minipage}{\linewidth}
                ...
                \vspace*{1em}
                {\Large {\bfseries \@author} \par \@institute \par}
        \end{minipage}};
...
\definecolorstyle{UofG}{
    ...
    \colorlet{blockodybgcolor}{white}
...
\block[bodyverticalshift=0cm, bodyinnersep=3mm]{}{\hspace{7mm}Exactly solving a hard graph problem
